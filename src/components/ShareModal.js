...
const ShareModal = ({ setShowShareModal, chatMode, userId, copiedMessage, setCopiedMessage }) => {
        ...
        <div className="flex flex-col space-y-3 mb-6">
          ...
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12.04 2C7.03 2 3 6.03 3 11.04c0 1.74.5 3.37 1.37 4.79L3 21l5.44-1.45c1.36.74 2.91 1.15 4.16 1.15 5.01 0 9.04-4.03 9.04-9.04C21.08 6.03 17.05 2 12.04 2zm3.64 14.64c-.23.23-.5.34-.78.34-.28 0-.55-.11-.78-.34l-.4-.4c-.11-.11-.22-.16-.34-.16-.12 0-.23.05-.34.16-.67.67-1.56 1.04-2.52 1.04-.96 0-1.85-.37-2.52-1.04-.67-.67-1.04-1.56-1.04-2.52 0-.96.37-1.85 1.04-2.52.11-.11.16-.22.16-.34 0-.12-.05-.23-.16-.34l-.4-.4c-.23-.23-.34-.5-.34-.78 0-.28.11-.55.34-.78z"/>
            </svg>
            Share on WhatsApp
          </a>
          <a
